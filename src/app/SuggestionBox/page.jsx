...
const SuggestionBox = () => {
    ...
    return (
        <>
            ...
            <div className="relative max-w-[1450px] mx-auto px-10  bredcrumbSectionMain">
                    {/* Breadcrumb Section */}
                    <div className="relative flex w-full max-w-[1450px] gap-5 px-2 py-12 breadCrumbSubSection">
                        ...
                        >
                            <ol className="flex flex-wrap space-x-2 justify-center md:justify-start text-center md:text-left">
                                ...
                                <span className="text-gray-400 arroSvgCrumPadding pt-1">
                                    <svg
                                ...
                                <li>
                                    <span className="breadcrumbFontBlack font-avenir">Suggestion Box</span>
                                </li>
                            </ol>
                        </nav>
                    </div>

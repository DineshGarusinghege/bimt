    ...
    return (
        <header className={`mainHeader-container bg-white shadow ${isSticky ? "sticky top-0 z-50" : ""}`} style={{ zIndex: '1000' }}>
            ...
            <div className="flex justify-between items-center p-4 z-48 w-full mx-auto">
                ...
                {/* Desktop Navigation */}
                <nav className="hidden md:flex space-x-8 text-sm z-48 font-medium text-gray-800 items-center">
                    {/* Home */}
                    <div className="relative">
                        <Link href="/" className="hover:text-[#A02629] menuTitle">Home</Link>
                    </div>
                    {/* About Us */}
                    <div
                    ...
                    >
                        <Link href="/AboutUs" className="hover:text-[#A02629] menuTitle font-bold">About Us</Link>
                        {hoveredMenu === 'about' && (
                            <ul className="absolute left-0 top-full mt-2 bg-white shadow-lg p-4 rounded-lg space-y-2 text-gray-800 w-64 z-50 headerSubmenu">
                                <li><Link href="/AboutUs" className="hover:text-[#A02629] menuTitle submenuTitile">Overview</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/OurJourney" className="hover:text-[#A02629] xt-blue-500 menuTitle submenuTitile">Our Journey</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/ChairmansMessage" className="hover:text-[#A02629] menuTitle submenuTitile">Chairman&#39;s Message</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/CEOsMessage" className="hover:text-[#A02629] menuTitle submenuTitile">CEO&#39;s Message</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/OurTeam" className="hover:text-[#A02629] menuTitle submenuTitile">Our Team</Link></li>
                                <hr className="border-gray-300" />
                            </ul>
                        )}
                    </div>
                    ...
                    <div
                        ...
                        onMouseLeave={() => toggleMenu(null)}
                    >
                        <Link href="/Search" className="hover:text-[#A02629] menuTitle">Programmes</Link>
                        {hoveredMenu === 'programs' && (
                            <ul className="absolute left-0 top-full mt-2 bg-white shadow-lg p-4 rounded-lg space-y-2 text-gray-800 w-64 z-50">
                                <li className="menuTitleList"><Link href="/CertificateProgrammes" className="hover:text-[#A02629] menuTitle">Certificate Programmes</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/Diploma" className="hover:text-[#A02629] menuTitle">Diploma</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/HigherNationalDiploma" className="hover:text-[#A02629] menuTitle"> Higher National Diploma</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/HigherDiploma" className="hover:text-[#A02629] menuTitle">Higher Diploma</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/BachelorsDegree" className="hover:text-[#A02629] menuTitle">Bachelors Degree</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/PostgraduateDiploma" className="hover:text-[#A02629] menuTitle">Postgraduate Diploma</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/MastersDegree" className="hover:text-[#A02629] menuTitle">Masters Degree</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/DoctorateDegree" className="hover:text-[#A02629] menuTitle">Doctorate Degree</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/CMI" className="hover:text-[#A02629] menuTitle">CMI (UK) <span style={{
                                    fontSize: '12px'
                                }}> - Management Skill Development Programme</span></Link></li>
                                <hr className="border-gray-300" />
                            </ul>
                        )}
                    </div>
                    ...
                    <div
                        ...
                        onMouseLeave={() => toggleMenu(null)}
                    >
                        <Link href="/CampusLife" className="hover:text-[#A02629] menuTitle">Life at BIMT</Link>
                        {hoveredMenu === 'life' && (
                            <ul className="absolute left-0 top-full mt-2 bg-white shadow-lg p-4 rounded-lg space-y-2 text-gray-800 w-64 z-50">
                                <li><Link href="/CampusLife" className="hover:text-[#A02629] menuTitle">Campus Life</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/Event" className="hover:text-[#A02629] menuTitle">Events</Link></li>
                                <hr className="border-gray-300" />
                            </ul>
                        )}
                    </div>
                    ...
                    <div
                        ...
                        onMouseLeave={() => toggleMenu(null)}
                    >
                        <Link href="/ContactUs" className="hover:text-[#A02629] menuTitle">Connect with Us</Link>
                        {hoveredMenu === 'contact' && (
                            <ul className="absolute left-0 top-full mt-2 bg-white shadow-lg p-4 rounded-lg space-y-2 text-gray-800 w-64 z-50">
                                <li className="menuTitleList"><Link href="/ContactUs" className="hover:text-[#A02629] menuTitle">Contact Us</Link></li>
                                <hr className="border-gray-300" />
                                {/* <li className="menuTitleList"><Link href="/ConnectwithUs" className="hover:text-[#A02629] menuTitle">Connect with Us</Link></li> */}
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/CareeratBIMT" className="hover:text-[#A02629] menuTitle">Career at BIMT</Link></li>
                                {/* <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/Blog" className="hover:text-[#A02629] menuTitle">Students Blogs</Link></li> */}
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/Testimonials" className="hover:text-[#A02629] menuTitle">Testimonials</Link></li>
                                <hr className="border-gray-300" />
                                <li className="menuTitleList"><Link href="/SuggestionBox" className="hover:text-[#A02629] menuTitle">Suggestion Box</Link></li>
                                <hr className="border-gray-300" />
                            </ul>
                        )}
                    </div>
                    ...
                    {/* Contact Numbers */}
                    <a href="tel:+94115332222" className="menuContactTitle">+94 115 33 22 22</a>
                ...
                <div className="hidden md:flex space-x-4 desktopHeaderBotton">
                    <Link href={'/ContactUs'}>
                        <button className="MainMenuContactBtn"><span>CONTACT US</span></button>
                    </Link>

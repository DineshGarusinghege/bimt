                ...
                <div className="max-w-[1498px] mx-auto py-10">
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="w-[917px]">
                            ...
                            >
                                <p>The ATHE Level 7 Extended Qualification in Accounting & Finance is a postgraduate program designed to help individuals advance their careers in accounting and finance. It provides comprehensive knowledge and practical skills in financial management, business strategy, and corporate governance. This qualification is ideal for those aiming for senior roles or looking to enhance their expertise to progress in the field. It enables students to analyze complex financial data, make informed strategic decisions, and effectively manage financial resources. Recognized by employers, it offers a pathway to further academic study or professional certification, making it suitable for individuals aspiring to roles such as finance manager, financial controller, or management accountant.</p>
                            </ul>
                            {/* Overview 2 */}
                            ...
                            <img
                                ...
                                src='/images/athe---Awarded-for-Training-and-higher-education (1) 1.png'
                            />
                             <h2 className="text-2xl font-bold mt-2"
                                style={{
                                    color: '#272A5D',
                            ...
                            <span>Part time (Saturday and Sunday)</span>

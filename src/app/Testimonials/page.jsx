    ...
    const testimonials = [
        {
            ...
            image: "/images/2-3-1024x1024 (1).jpg",
        },
        {
            name: "Azeem Ajmil",
            ...
            image: "/images/3-3-1024x1024.jpg",
        ...
        },
        {
            ...
            image: "/images/4-4-1024x1024.jpg",
        ...
        },
        {
            ...
            image: "/images/5-5-1024x1024.jpg",
        ...
        },
        {
            ...
            image: "/images/erw-1024x1024.jpg",
                    ...
                    <nav
                        ...
                        >
                            <ol className="flex space-x-2">
                                ...
                                <li>
                                    <span className="breadcrumbFontBlue text-bold font-avenir">Testimonials</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                {testimonials.map((testimonial) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col md:flex-row items-center lg:items-start">
                                            ...
                                            >
                                                <img className="w-32 h-32 rounded-full object-cover" src={testimonial.image} alt={`${testimonial.name}'s photo`} />
                                            </div>
                                            {/* Name and Details */}

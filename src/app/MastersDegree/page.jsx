...
export default function MastersDegree() {
        ...
        const fetchCourses = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    const MasterDegree = data.data.filter((course) =>
                        course.program === "Master Degree"
                    );

                    setCourses(MasterDegree);
                    console.log("Filtered Higher Diploma Courses:", MasterDegree); // Debugging filtered data
                }
            } catch (error) {
    ...
    return (
        ...
        <>
            <head>
                <title>Masters Degree | BIMT Campus</title>
                <meta
                    name="description"

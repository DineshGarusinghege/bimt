...
export default function BachelorsDegree() {
        ...
        const fetchCourses = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    const BachelorsDegree = data.data.filter((course) =>
                        course.program === "Bachelors Degree"
                    );

                    setCourses(BachelorsDegree);
                    console.log("Filtered Higher Diploma Courses:", BachelorsDegree); // Debugging filtered data
                }
            } catch (error) {
    ...
    return (
        ...
        <>
            ...
            <head>
                <title>Bachelors Degree | BIMT Campus</title>
                <meta
                    name="description"
                    content="BIMT Campus offers a range of globally recognized Bachelor's degree programs designed to equip students with in-depth knowledge, practical skills, and industry-relevant expertise. Our programs focus on fostering innovation, critical thinking, and leadership qualities, preparing graduates for successful careers in a competitive world."
                />
            </head>

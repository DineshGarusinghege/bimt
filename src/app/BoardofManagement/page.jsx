...
export default function BoardofGovernors() {
    const [selectedMember, setSelectedMember] = useState({
        ...
        image: "/images/CEO_new-look-1536x1504.jpg",
        description: [
    ...
    return (
        ...
        <>
            ...
            <section className="flex flex-col items-center mt-20 mb-[100px]">
                {/* Container */}
                <div className="flex flex-col lg:flex-row w-[1450px] mx-auto gap-[100px]">

                    {/* Left Section - Text */}
                    <div className="w-full lg:w-[45%] flex flex-col">
                        <h2 className="text-white text-[24px] leading-[28px] py-2 px-4 bg-[#272A5D] w-[56%]">
                            BOARD OF MANAGEMENT
                        </h2>
...
// export const dynamic = 'force-dynamic'; // Ensure the page does not get pre-rendered
...
//             image: "/images/CEO_new-look-1536x1504.jpg",
//             description: [
//                 `Mr. Farshath is a highly accomplished professional in field of education with over 15 years of experience. Currently serving as the Chief Executive Officer for the British Institute of Management and Technology, he has established himself as a visionary leader with a passion for excellence.`,
//                 `In addition to his role at the British Institute of Management and Technology, Mr. Farshath is also the Regional Director for the Institute of Financial Accountants (IFA) UK in Sri Lanka. His expertise in finance and accounting has made him a valuable asset to the organization.`,
//                 `An innovative and knowledgeable professional, Mr. Farshath has consistently delivered outstanding results throughout his career. His leadership skills, combined with his expertise in education and finance make him a valuable asset in the industry.`
//             ]
//         },
//         {
//             name: "Dr. Chethana Dabare",
...
//             image: "/images/0566eb17fe6577ed08462d29ea940202.png",
//             description: [
//                 `Dr. Dabare is a distinguished academic and business management professional with extensive qualifications and over 14 years of multifaceted experience in academia, industry, and research.`,
//                 `Her professional journey spans across diverse domains such as education, auditing, taxation, corporate secretarial work, university-level lecturing, and research supervision.`,
//                 `Dr. Dabare specializes in sustainability and marketing, areas in which she has conducted impactful research and published numerous works.`
//             ]
//         },
//         {
//             name: "Mr. Hashan Haputhanthri",
...
//     const [selectedMember, setSelectedMember] = useState(Governorsembers[0]);
...
//                         BOARD OF MANAGEMENT
//                     </h2>
//                     <p className="text-[#272A5D] text-justify text-[16px] leading-relaxed pt-2 px-4"
//                         style={{ borderTop: '2px solid #272A5D', borderLeft: '2px solid #272A5D' }}>
//                         The Board of Management at BIMT Campus is dedicated to steering the institution towards academic excellence, growth, and innovation.
//                     </p>

//                     {/* Member Thumbnails */}
//                     <div className="flex flex-col gap-[20px] mt-5">
//                         {Governorsembers.map((member, index) => (
//                             <button key={index} onClick={() => handleMemberClick(member)} className="flex items-center gap-3 cursor-pointer">
//                                 <Image
//                                     src={member.image}
//                                     alt={member.name}
//                                     width={100}
...
//                                 />
//                                 <span className="text-[#272A5D] font-medium">{member.name}</span>
//                             </button>
//                         ))}
//                     </div>
//                 </div>
...
//                         />
//                         {/* Member Info */}
//                         <h3 className="text-[#272A5D] font-bold text-[30px]">{selectedMember.name}</h3>
//                         <p className="text-[#272A5D] font-semibold text-[20px]">{selectedMember.position}</p>
//                     </div>

//                     {/* Member Description */}
//                     <p className="text-[#5A5A5A] text-justify text-[16px] font-normal mt-5">
//                         {selectedMember.description.map((paragraph, index) => (
//                             <span key={index}>
//                                 {paragraph}
//                                 <br /><br />

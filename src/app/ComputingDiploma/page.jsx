...
export default function ComputingDiploma() {
    ...
    const courses = [
        {
            ...
            category: 'Diploma',
            title: 'Diploma in',
            description: 'Diploma in Information & Communications Technology',
                    ...
                    >
                        <ol className="flex space-x-2">
                            ...
                            <li>
                                ...
                                >Computing Diploma Courses</span>
                            </li>
                        </ol>
                    </nav>

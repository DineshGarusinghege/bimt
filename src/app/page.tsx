...
const HomePage: React.FC = () => {
    ...
    useEffect(() => {
        // Set a timeout to show the video after 10 seconds
                ...
                <div className="relative heroSection">
                    ...
                    {showVideo && (
                        <div className="absolute inset-0 z-0 video-container">
                            {/* Black Overlay */}
                            <div
                                className="absolute inset-0 bg-white overlay-mobile"
                                style={{
                                    opacity: 0.1, // Adjust the opacity for the black overlay
                            ...
                            >
                                <iframe
                                    ...
                                    src="https://www.youtube.com/embed/qtWZidIlKJ0?autoplay=1&mute=1&loop=1&controls=0&modestbranding=1&rel=0&start=10&end=140&playlist=qtWZidIlKJ0"
                    ...
                    {/* Header Section */}
                    <div className="max-w-[1300px] mx-auto flex justify-between items-center h-full relative">
                        ...
                        {/* Header Content */}
                        <header
                            className={`absolute top-10 right-0 w-[250px] z-50 transition-transform duration-300 ease-in-out ${menuOpen ? "translate-x-0 opacity-100 pointer-events-auto" : "translate-x-full opacity-0 pointer-events-none"
                        ...
                        <div className="relative z-20 flex flex-col items-center justify-center text-center text-white h-full sm:items-start sm:text-left">
                            <h1 className="text-3xl md:text-5xl font-bold mb-4 meetOurDedicated">
                                WELCOME TO BIMT CAMPUS
                            </h1>
                            <p className="text-base md:text-lg max-w-xl heroDescription">
                            ...
                            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mt-8">
                                ...
                                <Link
                                    href="/AboutUs"
                                    className="btnWhite"
                                    style={{ width: '180px', paddingTop: '17px', paddingBottom: '17px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}
                                >
                    ...
                    >
                        ...
                        <div className="relative flex items-center w-full pr-4">
                            <input
                                ...
                                placeholder="Search your programms here..."
                        ...
                        <button
                            ...
                            className="ml-2 p-2 rounded-full hover:bg-gray-300 transition duration-150"
                        ...
                        <div>
                            <button
                                ...
                                className="btnBlue bg-[#272A5D] text-white px-4 py-2 rounded-lg font-semibold transition duration-150 text-sm md:text-lg searchBtn"
                                style={{
                                    width: '120px',
                                    height: '40px',
                                    fontSize: '16px',
            ...
            >
                ...
                >
                    ...
                    <div className="relative flex flex-col items-center p-6 border border-gray-300 border-b-4 border-red-800">
                        ...
                        <p className="text-gray-500 text-base mt-10">
                            Since BIMT offers a wide variety of programms, students may have several
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div>
                            {/* First Event */}
                            <div
                                className="flex py-6 border border-white mb-5 p-5 items-start gap-[67px] hover:scale-105 hover:shadow-lg transition-transform duration-300 ease-in-out"
                            >

...
export default function CourseContent() {
  const { setIsLoading } = useLoading();
    ...
    useEffect(() => {
        setIsLoading(true); // Show loader on mount
      ...
      <div className="max-w-screen-xl py-6 px-4 navMenu">
        <nav>
          <ol className="flex flex-wrap items-center space-x-2 text-sm md:text-base">
            ...
            <li>
              <span className="text-gray-600 navigationMenu">{course.courseName}</span>
            </li>
          </ol>
        </nav>
      </div>
        ...
        <div>
          <div className="max-w-[1300px] mx-auto py-6 flex justify-between items-center">
            ...
            <div className="flex gap-8">
              ...
              <button
                className={`text-gray-600 hover:text-blue-600 transition font-medium ${activeSection === "career-progression" ? "text-blue-600" : ""}`}
                onClick={() => setActiveSection("career-progression")}
                style={{
                  color: activeSection === "career-progression" ? "#0000FF" : "#000",
                  fontFamily: "Work Sans",
                  fontSize: "20px",
                  fontWeight: "500",
                }}

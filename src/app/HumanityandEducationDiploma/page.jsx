...
export default function HumanityandEducationDiploma() {
    ...
    const courses = [
        {
            ...
            img: '/images/3 (1) 1 (9).png',
        },
        {
            id: 2,
            category: 'Diploma',
            title: 'Diploma in',
            description: 'Counselling and Psychology',
    ...
    return (
        ...
        <>
            ...
            <head>
                <title>Humanity and Education Diploma | BIMT Campus</title>
                <meta
                    name="description"
                    content="BIMT Campus offers a Humanity and Education Diploma designed to inspire a deeper understanding of social sciences and educational principles. This program equips students with the skills to create meaningful change in communities and contribute to the field of education."
                />
            </head>
                        ...
                        >
                            <ol className="flex space-x-2">
                                ...
                                <li>
                                    ...
                                    >Humanity & Education Diploma Courses</span>
                                </li>
                            </ol>
                        </nav>
            ...
            <div className="bg-[#F6F8FB] py-10 px-4 lg:px-16 pt-[150px]">
                ...
                <div className="text-center mb-8">
                    ...
                    >Humanity & Education Diploma Courses</h2>
                </div>

...
export default function DoctorateDegree() {
        ...
        const fetchCourses = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    const DoctorateDegree = data.data.filter((course) =>
                        course.program === "Doctorate Degree"
                    );

                    setCourses(DoctorateDegree);
                    console.log("Filtered Higher Diploma Courses:", DoctorateDegree); // Debugging filtered data
                }
            } catch (error) {
    ...
    return (
        ...
        <>
            <head>
                <title>Decotorate Degree | BIMT Campus</title>
                <meta
                    name="description"
